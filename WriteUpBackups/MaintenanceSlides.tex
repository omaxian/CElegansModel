...
Wild type sequence
\begin{itemize}
\item Centrosomes $\rightarrow$ pPARs loaded
...
\item Focus: steady myosin/contractile asymmetry}
\end{itemize}
\end{column}

\begin{column}{0.5\textwidth}
\visible<1->{
\includegraphics[width=\textwidth]{CElegansScheme1.pdf}}
\vspace{0.25 cm}
\visible<2->{
\includegraphics[width=\textwidth]{CElegansScheme2.pdf}}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}{Standard version of the story: transient cues}
Transient establishment phase cue generates myosin asymmetry, maintained at later times by PARs

\begin{center}
\includegraphics[width=0.8\textwidth]{GrossFig1.png}
\end{center}
\blfootnote{\tiny{Gross et al. \emph{Nat.\ Phys.\ } (2019)}}
\end{frame}

\begin{frame}{Standard version of the story: steady flows?}
Q1: Despite steady myosin asymmetry, no flows in model?

\begin{center}
\includegraphics[width=0.8\textwidth]{GrossFig2.png}
\end{center}
Q2: Experiment shows shifting flow pattern: what to make of this?
\blfootnote{\tiny{Gross et al. \emph{Nat.\ Phys.\ } (2019)}}
\end{frame}

\begin{frame}{Standard version of the story: why there are no flows }
Q1: Contractility is saturated \emph{everywhere}!
\begin{center}
\includegraphics[width=0.8\textwidth]{GrossFig3.png}
\end{center}
Q2: Shifting flow profile $\rightarrow$ new phase 
\blfootnote{\tiny{Gross et al. \emph{Nat.\ Phys.\ } (2019)}}
\end{frame}

\begin{frame}{Equally disappointing? }
\begin{center}
\includegraphics[width=0.8\textwidth]{GoldenBatch.png}
\end{center}
\end{frame}
...
\movie[width=\textwidth,loop]{\includegraphics[width=\textwidth]{WildTypeMid.jpg}}{PresentationFigsMovies/WildType.avi}
\end{center}
\end{column}
\begin{column}{0.5\textwidth}
\begin{center}
...
\movie[width=\textwidth,loop]{\includegraphics[width=\textwidth]{Arx2RNAi.png}}{PresentationFigsMovies/Arx2RNAi.avi}
\end{center}
\end{column}
\end{columns}
...
\item \lightgray{Is this an \emph{attractive} steady state? Or does it depend on establishment? \checkmark}
\item \lightgray{Can we understand this with a simple model? \xmark}
\item \lightgray{Can experiments identify the missing piece? \checkmark}
\item Does a re-informed model make the correct predictions?
\end{itemize}
\end{frame}

\begin{frame}{Rescue dynamics: a closer look}
\begin{center}
\includegraphics[width=0.9\textwidth]{RescueSequence.pdf}
\end{center}
\vspace{-0.5 cm}
Signature sequence of events
\begin{enumerate}
\item Sudden stalling and decrease of flow
\item Myosin boundary stops
\item Flow maximum fixed 
\end{enumerate}
No change in myosin peak!
\end{frame}

\begin{frame}{Modeling the effect of branched actin}
Experiments suggest sudden relief of anterior tension
\begin{itemize}
\item Model as CDC-42 threshold where branched actin is activated 
\end{itemize}
\begin{center}
\includegraphics[width=0.5\textwidth]{BranchedActModel.pdf}
\end{center}
\pause
\begin{itemize}
\item Idea: threshold has to be between the A/P CDC-42 levels
\end{itemize}
\begin{center}
\vspace{-0.1 cm}

\movie[width=0.5\textwidth,loop]{\includegraphics[width=0.5\textwidth]{RescueBA06Still.pdf}}{PresentationFigsMovies/FlowRescueBA06.avi}
\end{center}
\end{frame}
...
\movie[width=\textwidth,loop]{\includegraphics[width=\textwidth]{RescueBA02Still.pdf}}{PresentationFigsMovies/FlowRescueBA02.avi}
\end{center}
\end{column}
\begin{column}{0.5\textwidth}
...
\movie[width=\textwidth,loop]{\includegraphics[width=\textwidth]{RescueBA1Still.pdf}}{PresentationFigsMovies/FlowRescueBA1.avi}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{center}
\includegraphics[width=\textwidth]{PAR3KymosRescueBA.pdf}
\end{center}
\vspace{0.5 cm}
...
\begin{center}
\includegraphics[width=\textwidth]{FlowKymosRescueBA.pdf}
\end{center}
\vspace{0.5 cm}
...
\begin{center}
\includegraphics[width=\textwidth]{FlowSpeedBAVsExp.pdf}
\end{center}
...
\end{itemize}
\begin{center}
\includegraphics[width=0.3\textwidth]{IncoherentFF.pdf}
\end{center}
